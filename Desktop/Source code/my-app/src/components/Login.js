  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="absolute top-4 left-4 z-20">
        <Button variant="ghost" className="flex items-center gap-2 text-white hover:text-purple-200 bg-purple-900/20 backdrop-blur-md italic">
          <Home className="w-5 h-5" />
          <Link to="/">
          <span className="text-lg font-bold">OceanVie</span>
          </Link>
        </Button>
      </div>
